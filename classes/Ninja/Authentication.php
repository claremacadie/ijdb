...
//Sessions are used so users only login once to the website, rather than every time they want to make a change to the database
//Set the namespace as Ninja
namespace Ninja;

//Set the class name as Authentication (this should be the same as the name of the file to enable autoloading)
class Authentication
{
	//Set the inputs to the class
	private $users;
	...
	//$usernameColumn is an input that is the name of the colomn that stores the login names, and
